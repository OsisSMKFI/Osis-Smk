    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            {/* Simple toggle between Front and Back - no 3D flip */}
            <AnimatePresence mode="wait">
              {!isFlipped ? (
                ...
                >
                  <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-6 sm:p-8 md:p-10 shadow-2xl border border-white/10 rounded-3xl">
                    <div className="flex flex-col md:grid md:grid-cols-5 gap-6 md:gap-10 items-center">
                      ...
                      >
                        {/* Label */}
                        <span className="inline-flex items-center gap-3 text-yellow-400 text-xs sm:text-sm tracking-[0.2em] uppercase mb-3 sm:mb-4">
                        ...
                        {/* Divider */}
                        <div 
                          className="h-1 w-[120px] rounded-full mb-5 mx-auto md:mx-0"
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                          <motion.button
                            ...
                            className="flex-1 px-6 py-3.5 bg-white/10 backdrop-blur-sm text-white font-semibold text-sm rounded-xl border border-white/20 hover:bg-white/20 transition-all flex items-center justify-center gap-2"
