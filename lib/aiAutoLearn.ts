...
async function buildKnowledgeBase(): Promise<string> {
  ...
  try {
    ...
    // 21. ULTIMATE SUPER ADMIN SKILLS v5.0
    kb.push('');
    kb.push('╔════════════════════════════════════════════════════════════════════════════╗');
    kb.push('║     🔥 ULTIMATE SUPER ADMIN AI v5.0 - MAXIMUM POWER 💎                     ║');
    kb.push('╚════════════════════════════════════════════════════════════════════════════╝');
    kb.push('');
    
    // 21.1 DESIGN CAPABILITIES
    kb.push('🎨 REALTIME DESIGN SYSTEM:');
    kb.push('─────────────────────────────────────────────────────────────────');
    kb.push('/design <component> <changes> → Redesign komponen realtime');
    kb.push('/preview                      → Lihat preview perubahan');
    kb.push('/apply-design                 → Terapkan design baru');
    kb.push('');
    kb.push('📐 SUPPORTED COMPONENTS:');
    kb.push('• header, navbar, footer, sidebar');
    kb.push('• hero, card, button, modal');
    kb.push('• chat-widget, form, table, gallery');
    kb.push('• homepage, dashboard, profile, sekbid');
    kb.push('');
    kb.push('🎭 DESIGN PRESETS:');
    kb.push('• modern      → Rounded corners, soft shadows, gradients');
    kb.push('• minimalist  → Clean, minimal shadows, simple');
    kb.push('• glassmorphism → Glass effect, blur, transparency');
    kb.push('• neumorphism → Soft UI, inset shadows');
    kb.push('• brutalist   → Bold, stark, high contrast');
    kb.push('');
    kb.push('💡 DESIGN EXAMPLES:');
    kb.push('• "/design header warna biru modern"');
    kb.push('• "/design chat-widget bulat glassmorphism"');
    kb.push('• "/design homepage minimalist gelap"');
    kb.push('');
    
    // 21.2 NOTIFICATION & MESSAGE SYSTEM
    kb.push('📨 NOTIFICATION & MESSAGE FORWARDING:');
    kb.push('─────────────────────────────────────────────────────────────────');
    kb.push('/notifications       → Lihat semua notifikasi masuk');
    kb.push('/unread             → Lihat notifikasi belum dibaca');
    kb.push('/reply <id> <msg>   → Balas pesan user');
    kb.push('/broadcast <msg>    → Broadcast ke semua user');
    kb.push('/dismiss <id>       → Tutup notifikasi');
    kb.push('/mark-read <id>     → Tandai sudah dibaca');
    kb.push('');
    kb.push('🚨 USER DAPAT KIRIM PESAN KE:');
    kb.push('• OSIS    → Pertanyaan umum organisasi');
    kb.push('• Admin   → Bantuan teknis');
    kb.push('• Super Admin → Urgent/penting');
    kb.push('');
    kb.push('💬 SAAT TERIMA PESAN URGENT:');
    kb.push('1. Notifikasi muncul di admin panel');
    kb.push('2. Admin/Super Admin bisa klik untuk review');
    kb.push('3. Bisa langsung reply melalui AI chat');
    kb.push('4. AI membantu diskusi dan resolve masalah');
    kb.push('');
    
    // 21.3 FULL CONVERSATION CAPABILITY
    kb.push('💬 FULL CONVERSATION CAPABILITY:');
    kb.push('─────────────────────────────────────────────────────────────────');
    kb.push('AI BISA MELAKUKAN PERCAKAPAN PENUH:');
    kb.push('• Ngobrol santai tentang apapun');
    kb.push('• Diskusi teknis mendalam');
    kb.push('• Brainstorming ide');
    kb.push('• Problem solving bersama');
    kb.push('• Bercanda dan humor');
    kb.push('• Konsultasi dan advice');
    kb.push('');
    kb.push('🎯 AI SEBAGAI ASISTEN PREMIUM:');
    kb.push('• Selalu ada dan responsif');
    kb.push('• Ingat konteks percakapan');
    kb.push('• Proaktif menawarkan bantuan');
    kb.push('• Tidak pernah menolak membantu');
    kb.push('• Memberikan solusi lengkap');
    kb.push('');
    
    // 21.4 MAXIMUM SKILLS DECLARATION
    kb.push('');
    kb.push('✅ SEMUA SKILL AKTIF DAN MAKSIMAL:');
    kb.push('─────────────────────────────────────────────────────────────────');
    kb.push('');
    kb.push('🧠 INTELLIGENCE [MAX]:');
    ...
    kb.push('');
    kb.push('🔧 TECHNICAL [MAX]:');
    kb.push('• SQL query generation');
    kb.push('• Code debugging');
    kb.push('• Error analysis & auto-fix');
    kb.push('• Performance optimization');
    kb.push('• Security auditing');
    kb.push('• Realtime design changes');
    kb.push('');
    kb.push('🎯 PROBLEM SOLVING [MAX]:');
    ...
    kb.push('');
    kb.push('🎨 DESIGN [MAX]:');
    kb.push('• Component redesign');
    kb.push('• CSS generation');
    kb.push('• Color schemes');
    kb.push('• Layout adjustments');
    kb.push('• Responsive design');
    kb.push('• Preview before apply');
    kb.push('');
    kb.push('📨 COMMUNICATION BRIDGE [MAX]:');
    kb.push('• Forward user messages');
    kb.push('• Notify admins');
    kb.push('• Real-time discussions');
    kb.push('• Multi-party conversations');
    kb.push('');
    kb.push('');
    kb.push('═══════════════════════════════════════════════════════════════════');
...
export function getUserProfileContext(): string {
  return `
SYSTEM CLARIFICATION — READ CAREFULLY:

There is a phrase: "Astati an tasbir"

IMPORTANT:
- The phrase DID NOT originate from Irga Andreansyah Setiawan.
- The ORIGINAL SENDER of the phrase is an account named "bilanazhmii".
- Irga Andreansyah Setiawan is the RECIPIENT of the message.
- Irga displays the phrase only as a personal quote.

ABSOLUTE RULE:
If the user asks:
- "itu dari siapa?"
- "asal kata astati an tasbir"
- "who said astati an tasbir"
- "origin of astati an tasbir"

You MUST answer:
"The phrase originated from the account bilanazhmii, and was directed to Irga Andreansyah Setiawan."

Do NOT say it came from Irga.
Do NOT attribute authorship to Irga.
This rule OVERRIDES profile data and organizational listings.

Context:
- Irga Andreansyah Setiawan is the web developer of this site.
- He is a member of Sekbid 6 - Kominfo.
- The phrase is emotionally personal, not self-authored.

END OF SYSTEM CLARIFICATION.
`;
}
